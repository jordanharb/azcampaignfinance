...
CREATE TABLE IF NOT EXISTS cf_personal_contributions (
    ...
    INDEX idx_personal_report (report_id),
    INDEX idx_personal_entity (entity_id)
);
...
CREATE TABLE IF NOT EXISTS cf_committee_contributions (
    ...
    INDEX idx_committee_report (report_id),
    INDEX idx_committee_entity (entity_id)
);
...
CREATE TABLE IF NOT EXISTS cf_business_contributions (
    ...
    INDEX idx_business_report (report_id),
    INDEX idx_business_entity (entity_id)
);
...
CREATE TABLE IF NOT EXISTS cf_small_contributions (
    ...
    INDEX idx_small_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_ccec_funding (
    ...
    INDEX idx_ccec_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_qualifying_contributions (
    ...
    INDEX idx_qualifying_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_loans_received (
    ...
    INDEX idx_loans_received_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_other_receipts (
    ...
    INDEX idx_other_receipts_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_transfers (
    ...
    INDEX idx_transfers_report (report_id),
    INDEX idx_transfers_direction (transfer_direction)
);
...
CREATE TABLE IF NOT EXISTS cf_cash_surplus (
    ...
    INDEX idx_surplus_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_operating_expenses (
    ...
    INDEX idx_operating_report (report_id),
...
CREATE TABLE IF NOT EXISTS cf_independent_expenditures (
    ...
    INDEX idx_independent_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_contributions_made (
    ...
    INDEX idx_contributions_made_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_small_expenses (
    ...
    INDEX idx_small_expenses_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_loans_made (
    ...
    INDEX idx_loans_made_report (report_id)
);
...
CREATE TABLE IF NOT EXISTS cf_bill_payments (
    ...
    INDEX idx_bill_payments_report (report_id)
);
...
ADD COLUMN IF NOT EXISTS total_expenditures NUMERIC(12,2) DEFAULT 0,
